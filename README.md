...
<img src= https://img.shields.io/badge/API-24%2B-success/>
 ...
 ## О проекте
Тестовое приложение для отработки практических навыков по Android разработке. В результате работы написано приложение, в котором отображается содержится инофрмация о 
